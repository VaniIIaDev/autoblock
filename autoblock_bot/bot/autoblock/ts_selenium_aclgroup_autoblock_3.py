...
excluded_documents = ["no_force_captcha", "예외 1"]  # 예외 문서 리스트
...
def delete_document(document):
    ...
    WebDriverWait(driver, 5).until(EC.presence_of_element_located((By.XPATH, '//*[@id="logInput"]')))
    
    # logInput 입력란에 값 입력
    try:
        log_input = driver.find_element(By.XPATH, "//*[@id='logInput']")
        log_input.send_keys("자동 반달성 문서 삭제 | 이의가 있으시다면 하늘위키:문의 게시판을 통해 문의해 주세요.")
    except Exception as e:
